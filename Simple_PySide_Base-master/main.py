...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # SET WINDOW TITLE
        self.setWindowTitle('PARIKSHA')
        UIFunctions.labelTitle(self, 'PARIKSHA')
        UIFunctions.labelDescription(self, 'START TEST')
        # END
        ...
        # USER ICON ==> SHOW HIDE
        UIFunctions.userIcon(self, "EX", "", True)
        # END
